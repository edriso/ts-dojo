...
// ------------------------------------------------------------------
// Your mission: Write an interface called TaskCardProps with:
//   - taskId: number
//   - title: string
//   - status: string
//   - isComplete: boolean
...
// ------------------------------------------------------------------
// Your mission: Write a type alias called FetchState with:
//   - loading: boolean
//   - error: string | null
//   - data: unknown
//
...
// ------------------------------------------------------------------
// Your mission: Write an interface UserProfile with:
