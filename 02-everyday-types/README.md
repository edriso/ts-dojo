...
> *Your starter blades. Every ninja carries them, every day.*
...
**Kata 1 - Type all the primitives**
...
**Kata 5 - Fixing it with unknown**
Now redo Kata 4 using `unknown` instead of `any`.
...
**Kata 11 - Error handling with never**
...
We will revisit this with proper types in Scroll 04.
...
- https://www.typescriptlang.org/docs/handbook/2/narrowing.html (preview for Scroll 08)
